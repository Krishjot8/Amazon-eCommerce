...
{
    public class BusinessUserLoginDto  //Angular User Login Entity  
    {

        [Required(ErrorMessage = "Enter Your Mobile Number or Email Address")]
        [BusinessLoginIdValidation]
    ...
    public class BusinessLoginIdValidationAttribute : ValidationAttribute
    {
